...
#    Updated: 2022/06/20 17:04:46 by ejang            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT_SRCS = ft_memset.c ft_substr.c ft_strdup.c ft_strlcpy.c ft_strlen.c ft_isalnum.c ft_isalpha.c ft_split.c ft_strncmp.c ft_isdigit.c ft_strjoin.c ft_itoa.c ft_tolower.c ft_putstr_fd.c ft_atoi.c ft_putnbr_fd.c ft_putendl_fd.c ft_strlcat.c
...
REDIR_SRCS = redir_in.c without_redir.c
