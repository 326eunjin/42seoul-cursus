...
#    Updated: 2022/06/12 22:26:11 by ejang            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT_SRCS = ft_memset.c ft_substr.c ft_strdup.c ft_strlcpy.c ft_strlen.c ft_isalnum.c ft_isalpha.c ft_split.c ft_strncmp.c ft_isdigit.c
PARSE_SRCS = main.c parse_main.c parse_token.c parse_cmd.c parse_cmd_utils.c parse_cmd_type.c
BUILTIN_SRCS = func_pwd.c exe_cmd.c func_env.c func_echo.c func_export.c func_unset.c
